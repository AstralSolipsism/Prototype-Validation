...
Workflow run: 31266477416
Validated source: de607214998bd15d3b282918e7b15cbd6a0e4b54
...
[1m[92m    Finished[0m `dev` profile [optimized + debuginfo] target(s) in 5.44s
...
[1m[91merror[0m[1m: duplicated attribute[0m
   [1m[94m--> [0mapps/integrated_world_visual/src/main.rs:921:9
    [1m[94m|[0m
[1m[94m921[0m [1m[94m|[0m #[allow(clippy::too_many_arguments)]
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
    [1m[94m|[0m
[1m[92mnote[0m: first defined here
   [1m[94m--> [0mapps/integrated_world_visual/src/main.rs:917:9
...
[1m[91merror[0m[1m: duplicated attribute[0m
    [1m[94m--> [0mapps/integrated_world_visual/src/main.rs:1375:9
     [1m[94m|[0m
[1m[94m1375[0m [1m[94m|[0m #[allow(clippy::too_many_arguments)]
     [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
     [1m[94m|[0m
[1m[92mnote[0m: first defined here
...
[1m[91merror[0m[1m: duplicated attribute[0m
    [1m[94m--> [0mapps/integrated_world_visual/src/main.rs:1377:9
     [1m[94m|[0m
[1m[94m1377[0m [1m[94m|[0m #[allow(clippy::too_many_arguments)]
     [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
     [1m[94m|[0m
[1m[92mnote[0m: first defined here
    [1m[94m--> [0mapps/integrated_world_visual/src/main.rs:1373:9
...
[1m[92m    Checking[0m replay_core v0.1.0 (/home/runner/work/Prototype-Validation/Prototype-Validation/crates/replay_core)
[1m[91merror[0m: could not compile `integrated_world_visual` (bin "integrated_world_visual" test) due to 4 previous errors
[1m[33mwarning[0m: build failed, waiting for other jobs to finish...
[1m[91merror[0m: could not compile `integrated_world_visual` (bin "integrated_world_visual") due to 4 previous errors
```
